...
#define Y 5	//二维数组的y值
	...
	int movedelete() {
		...
		/*初始化boss、方框、精灵*/
		loadimage(&_0, "第四张背景.jpg", 1000, 700);//背景
		loadimage(&_1, "q2.png", 500, 400);//加载消除框
		loadimage(&_2, "第四张boss白底.png", 500, 400);//加载boss白底
		loadimage(&_3, "第四张boss黑底.png", 500, 400);//加载boss黑底
